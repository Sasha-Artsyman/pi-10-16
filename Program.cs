...
namespace Pi_Printer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //base 16 "raw output", truncated at 30 chars 
            ...
            //post-format remaining entries with zeros to make strings equal length, and make tabular addition possible 
            for (int i = 0; i < 250; i++)
            {
            ...
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine("By exploiting the unlimited nature of strings this program calculates pi to 21 places which is 6 more than can be obtained using double values alone");
